...
void protobuf_AddDesc_Stage_2eproto() {
  ...
  ::pb::protobuf_AddDesc_Motion_2eproto();
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\013Stage.proto\022\002pb\032\014Motion.proto\"\035\n\005Point"
...
const Point& Point::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_Stage_2eproto();  return *default_instance_;
}
