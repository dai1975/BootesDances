#ifndef BOOTESDANCES_VIEW_CEGUIWIIMOTEWINDOW_H
#define BOOTESDANCES_VIEW_CEGUIWIIMOTEWINDOW_H

#include "../../include.h"
#include <map>
#include <string>
#include <list>
#include <bootes/cegui/D3DX9GeometryBuffer.h>
...
private:
   ...
   MyDirect3D9GeometryBuffer* _mygeo;
//   MyTimeGridRenderer* _myrenderer;
   //typedef std::list< IDirect3DTexture9* > t_lTextTex;
