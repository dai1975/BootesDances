#ifndef BOOTESDANCES_MOVE_MOVEMODELELLIPSE_H
#define BOOTESDANCES_MOVE_MOVEMODELELLIPSE_H

#include "../include.h"
#include "MoveModel.h"

class MoveModelEllipse: public MoveModel
{
public:
   MoveModelEllipse();
   MoveModelEllipse(const MoveModelEllipse&);
   virtual ~MoveModelEllipse();
   virtual MoveModel* clone() const { return new MoveModelEllipse(*this); }
   virtual inline TYPE getType() const { return T_ELLIPSE; }
