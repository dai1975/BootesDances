...
public:
   ...
   enum MOTION_TEST_STATE  { MOTION_TEST_DEFAULT,  MOTION_TEST_TESTING, MOTION_TEST_SUCCEED, MOTION_TEST_FAILED, };
   enum MOTION_TEACH_STATE { MOTION_TEACH_DEFAULT, MOTION_TEACH_TEACHING };
   MOTION_TEST_STATE getMotionTestState() const;
   MOTION_TEACH_STATE getMotionTeachState() const;
protected:
   std::string _uuid;
   __int64 _t0, _t1;
