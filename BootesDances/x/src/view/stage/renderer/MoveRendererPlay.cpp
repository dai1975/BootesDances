   ...
   for (MoveSequence::const_iterator i=i0; i!=i1; ) {
      ...
      for (MoveSequence::const_iterator g=g0; g!=g1; ++g) {
         ...
         { //モデル描画
            ...
            switch (m->getMotionState()) {
            case MoveModel::MOTION_FAILED:
         ...
         { //マーカー描画
            ...
            switch (m->getMotionState()) {
            case MoveModel::MOTION_TEACH:
               color = D3DCOLOR_ARGB(255, 255, 0, 0);
            case MoveModel::MOTION_DEFAULT:
            case MoveModel::MOTION_TEST:
               {
