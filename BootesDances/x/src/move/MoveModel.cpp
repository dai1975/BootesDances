...
MoveModel::MOTION_STATE MoveModel::getMotionState() const
{
   {
      ...
      if (s == Motion::TEACH_TEACHING) { return MoveModel::MOTION_TEACH; }
   }
   ...
   switch (s) {
   case Motion::TEST_DEFAULT: return MOTION_DEFAULT;
   case Motion::TEST_TESTING: return MOTION_TEST;
   case Motion::TEST_SUCCEED: return MOTION_SUCCEED;
   case Motion::TEST_FAILED: return MOTION_FAILED;
   }
